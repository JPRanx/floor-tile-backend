...
class AlertType(str, Enum):
    ...
    FACTORY_ORDER_CONFIRMED = "FACTORY_ORDER_CONFIRMED"
    FACTORY_ORDER_READY = "FACTORY_ORDER_READY"
    SHIPMENT_AT_ORIGIN = "SHIPMENT_AT_ORIGIN"
    PACKING_LIST_PROCESSED = "PACKING_LIST_PROCESSED"
    PACKING_LIST_PENDING = "PACKING_LIST_PENDING"
    BOOKING_AUTO_LINKED = "BOOKING_AUTO_LINKED"
    HBL_PROCESSED = "HBL_PROCESSED"
    HBL_PENDING = "HBL_PENDING"
    LINK_SHIPMENT_TO_ORDER = "LINK_SHIPMENT_TO_ORDER"
    LINK_ORDER_TO_SHIPMENT = "LINK_ORDER_TO_SHIPMENT"
